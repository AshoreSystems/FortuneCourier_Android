...
public class FragmentDrawerAssociate extends Fragment {

    private static String TAG = FragmentDrawerAssociate.class.getSimpleName();
    ...
    private static int[] images = {R.drawable.ic_dashboard,R.drawable.ic_orderlist_red,R.drawable.ic_track_red,R.drawable.ic_history_red,R.drawable.ic_calculate_red,R.drawable.ic_update_profile_red,R.drawable.ic_update_profile_red,R.drawable.ic_change_password_red,R.drawable.ic_change_number_red,R.drawable.ic_change_number_red,R.drawable.ic_share_app_red,R.drawable.ic_notifications_red,R.drawable.ic_contact_us_red,R.drawable.ic_logout};
    private FragmentDrawerListener drawerListener;
    TextView tv_username;
    RoundedImageView img_profile_pic;

    public FragmentDrawerAssociate() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // drawer labels
            ...
            titles = Arrays.asList(getActivity().getResources().getStringArray(R.array.nav_drawer_labels_associate));
    ...
    public void updateDrawerDetails() {
        tv_username.setText(mSessionManager.getStringData(SessionManager.KEY_A_FIRST_NAME) + " " + mSessionManager.getStringData(SessionManager.KEY_A_LAST_NAME));
        Picasso.with(getActivity())
                .load(mSessionManager.getStringData(SessionManager.KEY_A_PROFILE_URL)) //extract as User instance method
