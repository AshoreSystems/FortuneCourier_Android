...
import com.example.aspl.fortunecourier.DBHelper.DatabaseHelper;
...
public class ShipmentDetailsCustomerActivity extends Activity implements DatePickerDialog.OnDateSetListener, View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    int Year, Month, Day;
    private TextInputLayout textInput_ship_date,textInput_no_of_packages,textInput_customs_value;//,textInput_customs_description;
    private EditText editText_ship_date,editText_no_of_packages,editText_customs_value;//,editText_customs_description;
    ...
    public void init() {
        ...
        btn_get_quick_quote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideKeyboard();
               // showDesclaimer(ShipmentDetailsCustomerActivity.this);
                if(cd.isConnectingToInternet()){
                    validateAndNext();
                }else {
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
        ...
        rg_package_contents.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
               // int selectedId=rg_package_contents.getCheckedRadioButtonId();
                //Toast.makeText(ShipmentDetailsCustomerActivity.this,"=>"+selectedId,Toast.LENGTH_SHORT).show();
        ...
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ShipmentDetailsCustomerActivity.this, android.R.layout.simple_spinner_item, unit);
    ...
    public void onClick(View v) {
        ...
        DBInfo dbInfo = new DBInfo(ShipmentDetailsCustomerActivity.this);
...
*/
            case R.id.tv_get_detailed_quote:
                ...
                if(cd.isConnectingToInternet()){
                    if(strCarrierCode.equalsIgnoreCase("")){
                        customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_carrier));
                        customDialogForHelp.show();
                    } else if(strCarrierCode.equalsIgnoreCase("UPS")&&spinner_service_type.getSelectedItemPosition()==-1){
                        customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_service_type));
                        customDialogForHelp.show();
                    }
                    else {
                        //getSpecialServices();
                    ...
                    customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
                    customDialogForHelp.show();
                }
                break;
            ...
            case R.id.img_info:
                hideKeyboard();
                customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,"Help",dbInfo.getDescription("Calculate Rates Screen"));
                customDialogForHelp.show();
                break;

            case R.id.img_info_special_sevices:
                hideKeyboard();
                customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,"Help",dbInfo.getDescription("Calculate Rates Special Services"));
                customDialogForHelp.show();
                break;
    ...
    private void validateAndNext(){
        ...
        if(editText_ship_date.getText().toString().isEmpty()){
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_carrier));
            customDialogForHelp.show();
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_service_type));
            customDialogForHelp.show();
            // Snackbar.make(tv_package1,getResources().getString(R.string.lbl_select_service_type),Snackbar.LENGTH_SHORT).show();
        }else if(!(AppConstant.T_C_COUNTRY_CODE.equalsIgnoreCase("US")&& AppConstant.F_C_COUNTRY_CODE.equalsIgnoreCase("US"))&&spinner_service_type.getSelectedItemPosition()==-1){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_service_type));
            customDialogForHelp.show();
            // Snackbar.make(tv_package1,getResources().getString(R.string.lbl_select_service_type),Snackbar.LENGTH_SHORT).show();
        }
        else if(strCarrierCode != null &&!strCarrierCode.equalsIgnoreCase("USPS")&&spinner_pickup_drop.getSelectedItemPosition()==-1){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_pickup_drop));
            customDialogForHelp.show();
           // Snackbar.make(tv_package1,getResources().getString(R.string.lbl_select_pickup_drop),Snackbar.LENGTH_SHORT).show();
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_package_type));
            customDialogForHelp.show();
           // Snackbar.make(tv_package1,getResources().getString(R.string.lbl_select_package_type),Snackbar.LENGTH_SHORT).show();
        }else if(!(AppConstant.T_C_COUNTRY_CODE.equalsIgnoreCase("US")&& AppConstant.F_C_COUNTRY_CODE.equalsIgnoreCase("US"))&&strPackageContents.equalsIgnoreCase("")){
            ...
            customDialogForHelp.show();
        }else if(!(AppConstant.T_C_COUNTRY_CODE.equalsIgnoreCase("US")&& AppConstant.F_C_COUNTRY_CODE.equalsIgnoreCase("US"))&&rb_products_commodities.isChecked()&&editText_customs_value.getText().toString().trim().isEmpty()){
          /*  CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_package_contents));
            customDialogForHelp.show();*/
       ...
       /* else if(strCarrierCode != null&&strCarrierCode.equalsIgnoreCase("USPS")&&spinner_container_type.getSelectedItemPosition()==-1){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_container_type));
            customDialogForHelp.show();
       ...
       /* else if(strCarrierCode != null&&strCarrierCode.equalsIgnoreCase("USPS")&&spinner_sizes.getSelectedItemPosition()==-1){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.lbl_select_sizes));
            customDialogForHelp.show();
           // Snackbar.make(tv_package1,getResources().getString(R.string.lbl_select_sizes),Snackbar.LENGTH_SHORT).show();
        } */

       /* else if(!(AppConstant.T_C_COUNTRY_CODE.equalsIgnoreCase("US")&& AppConstant.F_C_COUNTRY_CODE.equalsIgnoreCase("US"))&&editText_customs_value.getText().toString().trim().isEmpty()) {
        ...
        else if(!(AppConstant.T_C_COUNTRY_CODE.equalsIgnoreCase("US")&& AppConstant.F_C_COUNTRY_CODE.equalsIgnoreCase("US"))&&editText_customs_description.getText().toString().trim().isEmpty()) {
          textInput_customs_description.setError(getResources().getString(R.string.msg_customs_desc));
            ...
            textInput_customs_value.setErrorEnabled(false);
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_package_info));
            customDialogForHelp.show();
            ...
            if(strTextViewNo.equalsIgnoreCase("2")&&(tv_package_details1.getText().toString().isEmpty()||tv_package_details2.getText().toString().isEmpty())){
                ...
                showDesclaimer(ShipmentDetailsCustomerActivity.this);
               /* if(rb_products_commodities.isChecked()){
                    startActivity(new Intent(ShipmentDetailsCustomerActivity.this,CommodityDetailsCustomerActivity.class));
                }else {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentDetailsCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                                    customDialogForHelp.show();
...
*/
    ...
    public void getContainerType(){
        try {
            ...
            String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_fetch_contianer_type);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ShipmentDetailsCustomerActivity.this, android.R.layout.simple_spinner_item, containerTypeList);
                                // set the view for the Drop down list
                                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                                // set the ArrayAdapter to the spinner
    ...
    public void getSizes(){
        try {
            ...
            String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_fetch_package_size);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ShipmentDetailsCustomerActivity.this, android.R.layout.simple_spinner_item, packageNameList);
                                // set the view for the Drop down list
                                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                                // set the ArrayAdapter to the spinner
    ...
    public void getShipmentPurpose(){
        try {
            ...
            String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_fetch_fedex_shipment_purpose);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ShipmentDetailsCustomerActivity.this, android.R.layout.simple_spinner_item, shipmentPurposesList);
                                // set the view for the Drop down list
                                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                                // set the ArrayAdapter to the spinner
    ...
    public void getDocuments(){
        try {
            ...
            String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_fetch_fedex_document_types);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ShipmentDetailsCustomerActivity.this, android.R.layout.simple_spinner_item, documentsList);
                                // set the view for the Drop down list
                                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                                // set the ArrayAdapter to the spinner
...
*/
    ...
    private void getSpecialServices(){
        ...
        progressBar.setIndeterminate(true);
        progressBar.show();
        String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_get_special_services);
        ...
        VolleyUtils.POST_METHOD(ShipmentDetailsCustomerActivity.this, URL,params, new VolleyResponseListener() {
            @Override
    ...
    private void showSpecialServices(final String titleShow,final String response){
        ...
        rg = new RadioGroup(ShipmentDetailsCustomerActivity.this); //create the RadioGroup
        rb = new RadioButton(ShipmentDetailsCustomerActivity.this);
        ...
        try {
            ...
            for (int noOfCustomOpt = 0; noOfCustomOpt < customOptnList.length(); noOfCustomOpt++) {
                ...
                CheckBox chk = new CheckBox(ShipmentDetailsCustomerActivity.this);
