...
import com.example.aspl.fortunecourier.activity.associate.ForgotPincodeAssociateActivity;
...
import com.example.aspl.fortunecourier.activity.customer.CreateShipmentFromCustomerActivity;
...
public class HomeCustomerFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.ll_calculate_rates:
                ...
                startActivity(new Intent(getActivity(), CheckRatesFromCustomerActivity.class));
                break;
            case R.id.ll_generate_shipment:
                ...
                startActivity(new Intent(getActivity(),CreateShipmentFromCustomerActivity.class));

                break;
            case R.id.ll_view_shipment_history:
                startActivity(new Intent(getActivity(), ShipmentHistoryCustomerActivity.class));
                break;
    ...
    private void getFlashText() {
        ...
        String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_dashboard);
