...
public class SetPhoneNumberAssociateActivity extends Activity implements View.OnClickListener{
    ...
    private void init(){
        cd = new ConnectionDetector(SetPhoneNumberAssociateActivity.this);
        mSessionManager = new SessionManager(SetPhoneNumberAssociateActivity.this);
    ...
    public void setPhoneNumber() {
        ...
        try {
            progressBar = new ProgressDialog(SetPhoneNumberAssociateActivity.this);
            ...
            String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_set_phone_no);
