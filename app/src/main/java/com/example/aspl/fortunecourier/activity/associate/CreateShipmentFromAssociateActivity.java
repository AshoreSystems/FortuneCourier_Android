...
public class CreateShipmentFromAssociateActivity extends Activity implements View.OnClickListener,AdapterView.OnItemSelectedListener,TextWatcher {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_info:
                hideKeyboard();
                DBInfo dbInfo = new DBInfo(CreateShipmentFromAssociateActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentFromAssociateActivity.this, "Help", dbInfo.getDescription("Create Shipment From Screen"));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        switch (parent.getId()){
            case R.id.spinner_country:
                ...
                AppConstant.F_A_COUNTRY_CODE = arrayListCountries.get(position).getCountry_code();
    ...
    public void getAllCountries() {
        ...
        try {
            progressBar = new ProgressDialog(CreateShipmentFromAssociateActivity.this);
            ...
            String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_get_from_countries);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString("status").equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(CreateShipmentFromAssociateActivity.this,
                                ...
                                if(mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)){
                                    editText_zip.setText(AppConstant.F_A_ZIPCODE);
                                    editText_zip.setTextColor( ContextCompat.getColor(CreateShipmentFromAssociateActivity.this,R.color.colorBlack));
                                    editText_zip.setEnabled(false);
                                    //editText_zip.setClickable(false);

                                    Log.e("Harshada","->"+ AppConstant.F_A_COUNTRY_CODE);
                                    for (int i = 0;i<arrayListCountries.size();i++) {
                                        ...
                                        if (arrayListCountries.get(i).getCountry_code().equalsIgnoreCase(AppConstant.F_A_COUNTRY_CODE)) {
                                            ...
                                            editText_country.setTextColor( ContextCompat.getColor(CreateShipmentFromAssociateActivity.this,R.color.colorBlack));
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)){
                                    if(AppConstant.F_A_COUNTRY_CODE.equalsIgnoreCase("US")){
                                       for(int i = 0; i<states.size(); i++) {
                                           if(AppConstant.F_A_STATE.equalsIgnoreCase(states.get(i))){
                                               spinner_state.setItemOnPosition(i);
                                               editText_city.setText(AppConstant.F_A_CITY);
                                           }
                                       }
                                    }
                                }
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    AppConstant.F_A_COUNTRY_CODE = strCountryCode;
                                    AppConstant.F_A_ZIPCODE = editText_zip.getText().toString().trim();
                                    progressBar.dismiss();
                                    startActivity(new Intent(CreateShipmentFromAssociateActivity.this,CreateShipmentToAssociateActivity.class));
                                }else {
       ...
       if(AppConstant.IS_FROM_CREATE_SHIPMENT) {
           if (cd.isConnectingToInternet()) {
               if (s.length() == 5) {
                   if (spinner_country.getSelectedItemPosition() == -1) {
                       Snackbar.make(spinner_country, getResources().getString(R.string.err_msg_select_country), Toast.LENGTH_SHORT).show();
                   } else if (AppConstant.F_A_COUNTRY_CODE.equalsIgnoreCase("US")) {
                       getZipcodeDetails(strCountryCode, editText_zip.getText().toString());
                   }
               }
           } else {
              /* CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentFromAssociateActivity.this, getResources().getString(R.string.app_name), getResources().getString(R.string.err_msg_internet));
               customDialogForHelp.show();*/
               Snackbar.make(spinner_city, getResources().getString(R.string.err_msg_internet), Snackbar.LENGTH_SHORT).show();
           }
       }
    ...
    public void afterTextChanged(Editable s) {
        ...
        private void getZipcodeDetails(String strCountryCode,String strZipcode){
            ...
            VolleyUtils.POST_METHOD(CreateShipmentFromAssociateActivity.this, URL, params, new VolleyResponseListener() {
                @Override
                ...
                public void onResponse(Object response) {
                    ...
                    try {
                        ...
                        if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                            ...
                            JSONObject jsonObject = Json_response.getJSONObject(JSONConstant.ERROR_MESSAGES);
                            if (jsonObject.has(JSONConstant.MESSAGE)) {
                                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentFromAssociateActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                                customDialogForHelp.show();
