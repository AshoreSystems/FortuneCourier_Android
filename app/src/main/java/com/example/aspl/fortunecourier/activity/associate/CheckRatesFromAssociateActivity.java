...
public class CheckRatesFromAssociateActivity extends Activity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    private void init(){
        ...
        dialogToShowList =  new DialogToShowList(CheckRatesFromAssociateActivity.this);
        ...
        if(cd.isConnectingToInternet()){
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesFromAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_info:
                hideKeyboard();
                DBInfo dbInfo = new DBInfo(CheckRatesFromAssociateActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesFromAssociateActivity.this,"Help",dbInfo.getDescription("Calculate Rates From Screen"));
                customDialogForHelp.show();
                break;
        }
    ...
    private void validateAndSubmit(){
        if(spinner_country.getSelectedItemPosition()==-1){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesFromAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_select_country));
            customDialogForHelp.show();
    ...
    public void showProgressDialog(){
        progressBar = new ProgressDialog(CheckRatesFromAssociateActivity.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString("status").equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(CheckRatesFromAssociateActivity.this,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    AppConstant.F_A_CITY =Json_response.getString("a_city");
                                    AppConstant.F_A_STATE =Json_response.getString("a_state");
                                    progressBar.dismiss();
                                    hideKeyboard();
                                    startActivity(new Intent(CheckRatesFromAssociateActivity.this,CheckRatesToAssociateActivity.class));
                                }else {
                                    ...
                                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesFromAssociateActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                                    customDialogForHelp.show();
