...
import com.example.aspl.fortunecourier.activity.customer.ResetPasswordCustomerActivity;
...
public class ResetPasswordAssociateActivity extends Activity implements View.OnClickListener{
    ...
    private void init(){
        cd = new ConnectionDetector(ResetPasswordAssociateActivity.this);
        mSessionManager = new SessionManager(ResetPasswordAssociateActivity.this);
        ...
        switch (v.getId()){
            case R.id.btn_submit:
                ...
                if(cd.isConnectingToInternet()){
                    ...
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ResetPasswordAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void resetPassword() {
        ...
        try {
            progressBar = new ProgressDialog(ResetPasswordAssociateActivity.this);
            ...
            String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_reset_password);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (status.equalsIgnoreCase(JSONConstant.SUCCESS)) {
                                    Toast.makeText(ResetPasswordAssociateActivity.this,getResources().getString(R.string.msg_password_change),Toast.LENGTH_SHORT).show();
                                    finish();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put(JSONConstant.A_PASSWORD, editText_new_password.getText().toString().trim());
    ...
    Thread thread = new Thread(){
        ...
        public void run() {
            try {
                ...
                startActivity(new Intent(ResetPasswordAssociateActivity.this, LoginAssociateActivity.class).putExtra(AppConstant.SIGNUP_OR_FORGOT_OTP,AppConstant.FORGOT_OTP));
                finish();
            } catch (Exception e) {
                e.printStackTrace();
            }
