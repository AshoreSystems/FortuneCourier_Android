...
public class CreateShipmentToCustomerActivity extends Activity implements View.OnClickListener,AdapterView.OnItemSelectedListener,TextWatcher{
    ...
    private ArrayList<Country> arrayListCountries;
    ...
    public void init(){
        ...
        if(cd.isConnectingToInternet()){
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_info:
                hideKeyboard();
                DBInfo dbInfo = new DBInfo(CreateShipmentToCustomerActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this, "Help", dbInfo.getDescription("Create Shipment To Screen"));
                customDialogForHelp.show();
                break;
        }
    ...
    private void validateAndNext(){
        if (spinner_country.getSelectedItemPosition()==-1){
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_select_country));
            customDialogForHelp.show();
        }
       /* else if(editText_company.getText().toString().trim().isEmpty()){
            ...
            textInput_city.setErrorEnabled(false);
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_select_state));
            customDialogForHelp.show();
    ...
    public void getAllCountries() {
        ...
        try {
            progressBar = new ProgressDialog(CreateShipmentToCustomerActivity.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString("status").equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(CreateShipmentToCustomerActivity.this,
                                ...
                                if(mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)){
                                    ...
                                    for (int i = 0;i<arrayListCountries.size();i++) {
                                        ...
                                        if (arrayListCountries.get(i).getCountry_code().equalsIgnoreCase(AppConstant.T_C_COUNTRY_CODE)) {
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)){
                                    if(AppConstant.T_C_COUNTRY_CODE.equalsIgnoreCase("US")){
                                        for(int i = 0; i<states.size(); i++) {
                                            if(AppConstant.T_C_STATE.equalsIgnoreCase(states.get(i))){
                                                spinner_state.setItemOnPosition(i);
                                                editText_city.setText(AppConstant.T_C_CITY);
                                            }
                                        }
                                    }
                                }
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    progressBar.dismiss();
                                    if(mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)){
                                        startActivity(new Intent(CreateShipmentToCustomerActivity.this,SummeryCustomerActivity.class));

                                    }else {
                                        DBCommodity dbCommodity = new DBCommodity(CreateShipmentToCustomerActivity.this);
                                        dbCommodity.deleteTableData(CreateShipmentToCustomerActivity.this);
                                        startActivity(new Intent(CreateShipmentToCustomerActivity.this,ShipmentDetailsCustomerActivity.class));

                                    }
                                }else {
                                    JSONObject jsonObject = Json_response.getJSONObject(JSONConstant.ERROR_MESSAGES);
                                    if (jsonObject.has(JSONConstant.MESSAGE)) {
                                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                                        customDialogForHelp.show();
                                    ...
                                    if(mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)&&jsonObject.has(JSONConstant.C_ZIPCODE)){
                                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.C_ZIPCODE));
                                        customDialogForHelp.show();
                                  ...
                                  /*  if (jsonObject.has(JSONConstant.C_ZIPCODE)){
                                    ...
                                    if (jsonObject.has(JSONConstant.COUNTRY_CODE)){
                                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.COUNTRY_CODE));
                                        customDialogForHelp.show();
                                    ...
                                    if (jsonObject.has(JSONConstant.C_STATE)){
                                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CreateShipmentToCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.C_STATE));
                                        customDialogForHelp.show();
    ...
    private void getZipcodeDetails(String strCountryCode,String strZipcode){
        ...
        VolleyUtils.POST_METHOD(CreateShipmentToCustomerActivity.this, URL, params, new VolleyResponseListener() {
            @Override
