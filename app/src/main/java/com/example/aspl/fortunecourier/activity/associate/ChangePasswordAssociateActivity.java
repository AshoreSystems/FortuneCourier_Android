...
public class ChangePasswordAssociateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void init(){
        mSessionManager = new SessionManager(ChangePasswordAssociateActivity.this);
        cd = new ConnectionDetector(ChangePasswordAssociateActivity.this);
        ...
        switch (v.getId()){
            case R.id.btn_submit:
                ...
                if(cd.isConnectingToInternet()){
                    ...
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ChangePasswordAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void changePassword() {
        ...
        try {
            progressBar = new ProgressDialog(ChangePasswordAssociateActivity.this);
            ...
            String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_change_password);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                               ...
                               if (Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                                   ...
                                   Toast.makeText(ChangePasswordAssociateActivity.this,Json_response.getString(JSONConstant.MESSAGE),Toast.LENGTH_SHORT).show();
                                   finish();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put(JSONConstant.A_OLD_PASSWORD, editText_old_password.getText().toString().trim());
