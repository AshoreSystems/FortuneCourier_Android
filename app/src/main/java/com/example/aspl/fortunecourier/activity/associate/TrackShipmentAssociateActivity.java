...
public class TrackShipmentAssociateActivity extends Activity implements View.OnClickListener{
    ...
    private void getTrackIdDetails(){
        progressBar = new ProgressDialog(TrackShipmentAssociateActivity.this);
        ...
        VolleyUtils.POST_METHOD(TrackShipmentAssociateActivity.this, URL, params, new VolleyResponseListener() {
            @Override
            ...
            public void onResponse(Object response) {
                ...
                try {
                    ...
                    if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                       ...
                       Intent intent =  new Intent(TrackShipmentAssociateActivity.this,TrackShipmentDetailsActivity.class);
                      ...
                      //  {"status":"success","shipment_details":{"shipment_id":"","carrier_name":"FedEX","service_type":"FedEx International Priority","PackagingType":"Your Packaging","PackageCount":1,"DropoffType":"","master_tracking_no":"771106546947","shipmentdate":"12\/29\/2017","shipmentday":"FRI","from_ac_country_code":"IN","from_ac_state":"TN","from_ac_address_line1":"","from_ac_city":"KANCHEEPURAM,","from_ac_zipcode":"","from_contact_name":"","to_contact_name":"","to_c_country_code":"US","to_c_state":"TX","to_c_address_line1":"","to_c_city":"MCKINNEY,","to_c_zipcode":"","expected_deliver_date":"01\/03\/2018","expected_deliver_day":"WED","status":"Delivered","base_amount":"","total_amount":"","surcharge":"","tax1":"","tax2":"","admin_commission":"","currency":"","is_identical":"","Packages":[{"Length":20,"Height":10,"Width":16,"Girth":"","DimensionUnit":"IN","CurrencyUnit":"","DesiredValue":"","PackageWeight":"21.8","WeightUnit":"LB"}]}}
                        ...
                        if (jsonObject.has(JSONConstant.MESSAGE)) {
                            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(TrackShipmentAssociateActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_get_details:
                ...
                if(cd.isConnectingToInternet()){
                    if(editText_track_id.getText().toString().trim().isEmpty()){
                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(TrackShipmentAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.hint_track_number));
                        customDialogForHelp.show();
                    ...
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(TrackShipmentAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
                    customDialogForHelp.show();
            ...
            case R.id.img_info:
                hideKeyboard();
                DBInfo dbInfo = new DBInfo(TrackShipmentAssociateActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(TrackShipmentAssociateActivity.this, "Help", dbInfo.getDescription("Track Shipment Screen"));
                customDialogForHelp.show();
                break;
