...
public class RegisterPincodeAssociateActivity extends Activity implements View.OnClickListener{
    ...
    private void validateAndRegister(){
        if(pinView_pincode.getText().toString().isEmpty()||pinView_pincode.getText().toString().length()<6){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(RegisterPincodeAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_pincode));
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(RegisterPincodeAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_pincode_not_matched));
            customDialogForHelp.show();
        }else {
            registerPincode();
        }
    ...
    private void registerPincode(){
        progressBar = new ProgressDialog(RegisterPincodeAssociateActivity.this);
        ...
        String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_set_pin);
        ...
        VolleyUtils.POST_METHOD(RegisterPincodeAssociateActivity.this, URL, params, new VolleyResponseListener() {
            @Override
            ...
            public void onResponse(Object response) {
                ...
                try {
                    ...
                    if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                        Intent i = new Intent(RegisterPincodeAssociateActivity.this, DashboardAssociateActivity.class);
                        ...
                        if (jsonObject.has(JSONConstant.MESSAGE)) {
                            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(RegisterPincodeAssociateActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                            customDialogForHelp.show();
                        }
                    }
                    progressBar.dismiss();
        ...
        switch (v.getId()){
            ...
            case R.id.btn_register:
                ...
                if(cd.isConnectingToInternet()){
                    ...
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(RegisterPincodeAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
                    customDialogForHelp.show();
                }
                break;
        }
