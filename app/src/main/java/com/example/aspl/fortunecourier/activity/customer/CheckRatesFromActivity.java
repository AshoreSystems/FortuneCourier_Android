...
public class CheckRatesFromActivity extends Activity implements View.OnClickListener,AdapterView.OnItemSelectedListener{
    ...
    private void init(){
        ...
        dialogToShowList =  new DialogToShowList(CheckRatesFromActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_info:
                hideKeyboard();
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesFromActivity.this,"Help",getResources().getString(R.string.info));
    ...
    public void getAllCountries() {
        ...
        try {
            progressBar = new ProgressDialog(CheckRatesFromActivity.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(Json_response.getString("status").equalsIgnoreCase(JSONConstant.SUCCESS)){
                                    ...
                                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(CheckRatesFromActivity.this,
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
       ...
       /* if(position==0){
        ...
        //strCountryCode = arrayListCountries.get(position-1).getCountry_code();
       // Toast.makeText(CheckRatesFromActivity.this,"->"+strCountryCode,Toast.LENGTH_SHORT).show();
