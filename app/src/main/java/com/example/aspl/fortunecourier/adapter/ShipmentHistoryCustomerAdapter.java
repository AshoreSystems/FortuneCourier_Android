...
public class ShipmentHistoryCustomerAdapter extends RecyclerView.Adapter<ShipmentHistoryCustomerAdapter.ViewHolder> {
    ...
    public ShipmentHistoryCustomerAdapter(List<HistoryDetails> offersListIn, Activity activity) {
    ...
    @Override
    public ShipmentHistoryCustomerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                        int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_shipment_history, parent, false);

        ShipmentHistoryCustomerAdapter.ViewHolder viewHolder = new ShipmentHistoryCustomerAdapter.ViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(ShipmentHistoryCustomerAdapter.ViewHolder holder, final int position) {
        ...
        holder.ll_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mActivity, HistoryDetailsCustomerActivity.class).putExtra("ShipmentId",historyList.get(position).getShipmentId());
