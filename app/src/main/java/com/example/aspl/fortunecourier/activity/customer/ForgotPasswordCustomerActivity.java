...
public class ForgotPasswordCustomerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void init(){
        cd = new ConnectionDetector(ForgotPasswordCustomerActivity.this);
        mSessionManager = new SessionManager(ForgotPasswordCustomerActivity.this);
        ...
        switch (v.getId()){
            case R.id.btn_submit:
                ...
                if(cd.isConnectingToInternet()){
                    ...
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ForgotPasswordCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void forgotPassword() {
        ...
        try {
            progressBar = new ProgressDialog(ForgotPasswordCustomerActivity.this);
            ...
            String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_forgot_password);
                            ...
                            try {
                                ...
                                if (Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                                    ...
                                    if (jsonObject.has(JSONConstant.MESSAGE)) {
                                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ForgotPasswordCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                                        customDialogForHelp.show();
