...
public class CommodityDetailsAssociateActivity extends Activity implements View.OnClickListener{
    ...
    private void init(){
        mSessionManager = new SessionManager(CommodityDetailsAssociateActivity.this);
        cd = new ConnectionDetector(CommodityDetailsAssociateActivity.this);
        ...
        Drawable horizontalDivider = ContextCompat.getDrawable(CommodityDetailsAssociateActivity.this, R.drawable.horizontal_divider);
        horizontalDecoration.setDrawable(horizontalDivider);
        recycler_commodity.addItemDecoration(horizontalDecoration);

        DBCommodity dbCommodity = new DBCommodity(CommodityDetailsAssociateActivity.this);
        arrayListOfCommodity = dbCommodity.getAllCommodityData();

        CommodityAdapter recyclerViewAdapter = new CommodityAdapter(arrayListOfCommodity,CommodityDetailsAssociateActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_add_commodity:
                startActivity(new Intent(CommodityDetailsAssociateActivity.this,CommodityAssociateActivity.class).putExtra("action","add"));
                //finish();
                break;
            ...
            case R.id.btn_submit:
                ...
                if(dbCommodity.getCommodityCount()>0){
                    ...
                    if(totalShipmentWeight<Double.valueOf(commodity.getCommodity_weight())){
                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CommodityDetailsAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_custom_weight));
                        customDialogForHelp.show();
                    }else if(totalCarriageValue>Double.valueOf(commodity.getCustoms_value())){
                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CommodityDetailsAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_custom_value));
                        customDialogForHelp.show();
                    }else if(!cd.isConnectingToInternet()){
                        CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CommodityDetailsAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
                        customDialogForHelp.show();
                    }else {
                        getCheckRateDetails();
                    }
...
*/
                    ...
                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CommodityDetailsAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.msg_select_commodity));
                    customDialogForHelp.show();
                }

                break;
            case R.id.img_info:
                DBInfo dbInfo = new DBInfo(CommodityDetailsAssociateActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CommodityDetailsAssociateActivity.this,"Help",dbInfo.getDescription("Calculate Rates Screen"));
                customDialogForHelp.show();
                break;
    ...
    private void getCheckRateDetails(){
        progressBar = new ProgressDialog(CommodityDetailsAssociateActivity.this);
        ...
        VolleyUtils.POST_METHOD(CommodityDetailsAssociateActivity.this, URL,params, new VolleyResponseListener() {
            @Override
            ...
            public void onResponse(Object response) {
                ...
                try {
                    ...
                    if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)){
                        ...
                        startActivity(new Intent(CommodityDetailsAssociateActivity.this,CheckRateScreenAssociateActivity.class).putParcelableArrayListExtra("RateList",ratesArrayList));
                 ...
                 /*       if(mSessionManager.getStringData(SessionManager.KEY_CARRIER_CODE).equalsIgnoreCase("USPS")) {
                        ...
                        progressBar.dismiss();
                        CustomDialogForHelp customDialogForHelp =new CustomDialogForHelp(CommodityDetailsAssociateActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                        customDialogForHelp.show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
