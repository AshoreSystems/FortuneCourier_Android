...
public class FragmentDrawerCustomer extends Fragment {
    ...
    private static int[] images = {R.drawable.ic_dashboard,R.drawable.ic_orderlist_red,R.drawable.ic_track_red,R.drawable.ic_history_red,R.drawable.ic_calculate_red,R.drawable.ic_update_profile_red,R.drawable.ic_change_password_red,R.drawable.ic_change_number_red,R.drawable.ic_change_number_red,R.drawable.ic_share_app_red,R.drawable.ic_notifications_red,R.drawable.ic_contact_us_red,R.drawable.ic_logout};
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // titles = getActivity().getResources().getStringArray(R.array.nav_drawer_labels);
        if(AppConstant.IS_USER_FROM_FACEBOOK_SIGNUP){
            ...
            titles = Arrays.asList(getActivity().getResources().getStringArray(R.array.nav_drawer_labels_customer));
        }
