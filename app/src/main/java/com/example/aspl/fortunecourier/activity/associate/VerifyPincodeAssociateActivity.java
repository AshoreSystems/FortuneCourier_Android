...
public class VerifyPincodeAssociateActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_forgot_pincode:
                hideKeyboard();
                startActivity(new Intent(VerifyPincodeAssociateActivity.this,ForgotPincodeAssociateActivity.class));
                break;
    ...
    private void validateAndVerify(){
        if(cd.isConnectingToInternet()) {
            if (pinView_pincode.getText().length() < 6) {
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(VerifyPincodeAssociateActivity.this, getResources().getString(R.string.app_name), getResources().getString(R.string.err_msg_pincode));
                ...
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(VerifyPincodeAssociateActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
                customDialogForHelp.show();
            }
        }
    ...
    private void verifyPincode() {
        showProgressDialog();
       /* progressBar = new ProgressDialog(VerifyPincodeAssociateActivity.this);
        ...
        String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_verify_pin);
        Map<String, String> params = new HashMap<String, String>();
        params.put(JSONConstant.A_ID, mSessionManager.getStringData(SessionManager.KEY_A_ID));
        params.put("a_security_pin", pinView_pincode.getText().toString().trim());
        System.out.println("=>" + params.toString());

        VolleyUtils.POST_METHOD(VerifyPincodeAssociateActivity.this, URL, params, new VolleyResponseListener() {
            @Override
            ...
            public void onResponse(Object response) {
                ...
                try {
                    ...
                    if (Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                        Toast.makeText(VerifyPincodeAssociateActivity.this, Json_response.getString(JSONConstant.MESSAGE), Toast.LENGTH_SHORT).show();
                        createShipment();
                        ...
                        if (jsonObject.has(JSONConstant.MESSAGE)) {
                            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(VerifyPincodeAssociateActivity.this, getResources().getString(R.string.app_name), jsonObject.getString(JSONConstant.MESSAGE));
                            customDialogForHelp.show();
                        }
                    }
                   // closeProgressBar();
    ...
    private void createShipment(){
       ...
       /* progressBar = new ProgressDialog(VerifyPincodeAssociateActivity.this);
        ...
        progressBar.setIndeterminate(true);
        progressBar.show();*/
        String URL = getResources().getString(R.string.url_domain_associate) + getResources().getString(R.string.url_create_shipment);
        Map<String, String> params = new HashMap<String, String>();
        params.put(JSONConstant.A_ID,mSessionManager.getStringData(SessionManager.KEY_A_ID));
        ...
        params.put(JSONConstant.FROM_A_ADDRESS_LINE2,mSessionManager.getStringData(SessionManager.KEY_F_ADDRESSLINE_2));
        ...
        params.put(JSONConstant.TO_A_STATE,mSessionManager.getStringData(SessionManager.KEY_T_STATE));
        params.put(JSONConstant.TO_A_ZIPCODE,mSessionManager.getStringData(SessionManager.KEY_T_ZIP_CODE));

        params.put(JSONConstant.TO_A_ADDRESS_LINE1,mSessionManager.getStringData(SessionManager.KEY_T_ADDRESSLINE_1));
        params.put(JSONConstant.TO_A_ADDRESS_LINE2,mSessionManager.getStringData(SessionManager.KEY_T_ADDRESSLINE_2));

        params.put(JSONConstant.TO_A_CITY,mSessionManager.getStringData(SessionManager.KEY_T_CITY));
        ...
        params.put(JSONConstant.TO_A_PHONE_NO,mSessionManager.getStringData(SessionManager.KEY_T_PHONE_NUMBER));
        params.put(JSONConstant.TO_A_DIALLING_CODE,mSessionManager.getStringData(SessionManager.KEY_T_DIALLING_CODE));
    ...
    params.put("token",getIntent().getStringExtra("token"));
     ...
     params.put("cvv",getIntent().getStringExtra("cvv"));
        ...
        DBCommodity dbCommodity = new DBCommodity(VerifyPincodeAssociateActivity.this);
        ...
        public void onResponse(Object response) {
            ...
            try {
                ...
                if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                    ...
                    DBCommodity dbCommodity= new DBCommodity(VerifyPincodeAssociateActivity.this);
                    dbCommodity.deleteTableData(VerifyPincodeAssociateActivity.this);

                    if(AppConstant.T_A_COUNTRY_CODE.equalsIgnoreCase("US")&& AppConstant.F_A_COUNTRY_CODE.equalsIgnoreCase("US")||Json_response.getString("note").isEmpty()){
                        Toast.makeText(VerifyPincodeAssociateActivity.this,Json_response.getString(JSONConstant.MESSAGE),Toast.LENGTH_SHORT).show();
    ...
    private void showNote(Context context, String strMessage, final String jsonMessage, final String pdfLabel, final String trackingNo){
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                dialog.dismiss();
                startActivity(new Intent(VerifyPincodeAssociateActivity.this,LabelAssociateActivity.class).putExtra(JSONConstant.STATUS,JSONConstant.SUCCESS).putExtra(JSONConstant.MESSAGE,jsonMessage).putExtra("pdf",pdfLabel).putExtra(JSONConstant.MASTER_TRACKING_NO,trackingNo));
                finish();
