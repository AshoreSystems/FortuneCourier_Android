 ...
 * @Author Avion Team.
 * @Date 17 july 2017.
 * @VolleyWebserviceForPost Class is use for call post type webservice.
 */
public class VolleyWebserviceForPost {String WhichWebservice, DialogStr, URL;
    JSONObject obj;
    Context mContext;
    ...
    public VolleyWebserviceForPost(Activity activity, Handler handler, String WhichWebservice, String URL, Map<String, String> params) {
        mContext = activity;
