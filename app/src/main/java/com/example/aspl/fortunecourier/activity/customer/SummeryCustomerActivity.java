...
public class SummeryCustomerActivity extends Activity implements View.OnClickListener{
       ...
       // tv_selected_service .setText( mSessionManager.getStringData(SessionManager.KEY_SELECTED_SERVICE_DESCRIPTION));
        ...
        if(mSessionManager.getStringData(SessionManager.KEY_CARRIER_CODE).equalsIgnoreCase("UPS")&&mSessionManager.getStringData(SessionManager.KEY_PICKUP_DROP).equalsIgnoreCase("06")){
            if(cd.isConnectingToInternet()){
                ...
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(SummeryCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.img_info:
                hideKeyboard();
                DBInfo dbInfo = new DBInfo(SummeryCustomerActivity.this);
                customDialogForHelp = new CustomDialogForHelp(SummeryCustomerActivity.this, "Help", dbInfo.getDescription("Create Shipment Summary Screen"));
                customDialogForHelp.show();
                break;
    ...
    private void getCollectionFees(){
        ...
        String URL = getResources().getString(R.string.url_domain_customer) + getResources().getString(R.string.url_fetch_pickup_rate);
        Map<String, String> params = new HashMap<String, String>();
        ...
        params.put(JSONConstant.FROM_C_PHONE_NO,mSessionManager.getStringData(SessionManager.KEY_F_PHONE_NUMBER));
        params.put(JSONConstant.FROM_C_DIALLING_CODE,mSessionManager.getStringData(SessionManager.KEY_F_DIALLING_CODE));
        params.put(JSONConstant.C_EMAIL_ADDRESS,mSessionManager.getStringData(SessionManager.KEY_C_EMAIL));
