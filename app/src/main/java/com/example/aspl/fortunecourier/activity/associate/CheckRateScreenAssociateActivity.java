...
import com.example.aspl.fortunecourier.adapter.CheckRateAssociateAdapter;
...
public class CheckRateScreenAssociateActivity extends Activity implements View.OnClickListener{
    private RecyclerView recycler_checklist;
    private ImageView img_info ;
    private Button btn_create_shipment,btn_proceed;
    private SessionManager mSessionManager;
    private CheckRateAssociateAdapter recyclerViewAdapter;
    ...
    private void init(){
        ...
        recyclerViewAdapter = new CheckRateAssociateAdapter(ciArr,CheckRateScreenAssociateActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.img_info:
                DBInfo dbInfo = new DBInfo(CheckRateScreenAssociateActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRateScreenAssociateActivity.this,"Help",dbInfo.getDescription("Rate and Transit Screen"));
           ...
           /* case R.id.btn_proceed:
                if (recyclerViewAdapter.lastSelectedPosition==-1){
                   ...
                   *//* AppConstant.IS_FROM_CREATE_SHIPMENT = false;
                    ...
                    startActivity(new Intent(CheckRateScreenAssociateActivity.this,SummeryCustomerActivity.class));
            ...
            case R.id.btn_create_shipment:
                ...
                if (recyclerViewAdapter.lastSelectedPosition==-1){
                    customDialogForHelp = new CustomDialogForHelp(CheckRateScreenAssociateActivity.this,getResources().getString(R.string.app_name),"Please select delivery date");
                    customDialogForHelp.show();
                    //Snackbar.make(btn_create_shipment,"Please select delivery date",Snackbar.LENGTH_SHORT).show();
                }else {
                    ...
                    //startActivity(new Intent(CheckRateScreenAssociateActivity.this,CreateShipmentFromCustomerActivity.class));

                    if(!mSessionManager.getBooleanData(SessionManager.KEY_IS_FROM_CALCULATE_RATES)){
                        // createShipment();
                        startActivity(new Intent(CheckRateScreenAssociateActivity.this,SummeryAssociateActivity.class));

                    }else {
                        // AppConstant.IS_FROM_CALCULATE_RATES = true;
                        startActivity(new Intent(CheckRateScreenAssociateActivity.this,CreateShipmentFromAssociateActivity.class));
                    }
    ...
    /*private void createShipment(){
        progressBar = new ProgressDialog(CheckRateScreenAssociateActivity.this);
        ...
        VolleyUtils.POST_METHOD(CheckRateScreenAssociateActivity.this, URL, params, new VolleyResponseListener() {
            @Override
            ...
            public void onResponse(Object response) {
                ...
                try {
                    ...
                    if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                        ...
                        Toast.makeText(CheckRateScreenAssociateActivity.this,Json_response.getString(JSONConstant.MESSAGE),Toast.LENGTH_SHORT).show();
                        ...
                        if (jsonObject.has(JSONConstant.MESSAGE)) {
                            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRateScreenAssociateActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                            customDialogForHelp.show();
