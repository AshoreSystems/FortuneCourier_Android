...
public class ShipmentHistoryCustomerActivity extends Activity implements View.OnClickListener{
...
*/
        ...
        Drawable horizontalDivider = ContextCompat.getDrawable(ShipmentHistoryCustomerActivity.this, R.drawable.horizontal_divider);
        ...
        if(cd.isConnectingToInternet()){
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentHistoryCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.header_layout_back:
                ...
                break;
            case R.id.img_info:
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentHistoryCustomerActivity.this,"Help",getResources().getString(R.string.info));
                customDialogForHelp.show();
                break;
        }
    }
    ...
    private void viewHistoryDetails(){
        ...
        progressBar = new ProgressDialog(ShipmentHistoryCustomerActivity.this);
        ...
        VolleyUtils.POST_METHOD(ShipmentHistoryCustomerActivity.this, URL, params, new VolleyResponseListener() {
            @Override
                ...
                try {
                    ...
                    if(Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                        ...
                        for(int i = 0; i< jsonArray.length() ; i++ ){
                            ...
                            historyDetails.setFromCountry(jsonObjectRate.getString(JSONConstant.FROM_C_COUNTRY_CODE));
                            historyDetails.setFromState(jsonObjectRate.getString(JSONConstant.FROM_C_STATE));
                            historyDetails.setToCountry(jsonObjectRate.getString(JSONConstant.TO_C_COUNTRY_CODE));
                            historyDetails.setToState(jsonObjectRate.getString(JSONConstant.TO_C_STATE));
                            historyDetails.setToCity(jsonObjectRate.getString(JSONConstant.TO_C_CITY));
                            historyDetails.setFromCity(jsonObjectRate.getString(JSONConstant.FROM_C_CITY));
                        ...
                        ShipmentHistoryCustomerAdapter recyclerViewAdapter = new ShipmentHistoryCustomerAdapter(listOfHistoryDeatils,ShipmentHistoryCustomerActivity.this);
                        ...
                        if (jsonObject.has(JSONConstant.MESSAGE)) {
                            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(ShipmentHistoryCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                            customDialogForHelp.show();
