...
import com.example.aspl.fortunecourier.activity.associate.CheckRatesToAssociateActivity;
import com.example.aspl.fortunecourier.activity.associate.CreateShipmentToAssociateActivity;
...
public class CheckRatesToCustomerActivity extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
   ...
   // private Spinner spinner_country;
    ...
    private void init() {
        ...
        if (cd.isConnectingToInternet()) {
            ...
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesToCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_internet));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_info:
                DBInfo dbInfo = new DBInfo(CheckRatesToCustomerActivity.this);
                CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesToCustomerActivity.this,"Help",dbInfo.getDescription("Calculate Rates To Screen"));
                customDialogForHelp.show();
                break;
        }
    ...
    private void validateAndSubmit(){
        if(spinner_country.getSelectedItemPosition()==-1){
            CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesToCustomerActivity.this,getResources().getString(R.string.app_name),getResources().getString(R.string.err_msg_select_country));
            customDialogForHelp.show();
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (Json_response.getString("status").equalsIgnoreCase(JSONConstant.SUCCESS)) {
                                    ...
                                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(CheckRatesToCustomerActivity.this,
    ...
    public void showProgressDialog(){
        progressBar = new ProgressDialog(CheckRatesToCustomerActivity.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (Json_response.getString(JSONConstant.STATUS).equalsIgnoreCase(JSONConstant.SUCCESS)) {
                                    ...
                                    AppConstant.T_C_CITY = Json_response.getString("c_city");
                                    AppConstant.T_C_STATE = Json_response.getString("c_state");
                                    progressBar.dismiss();
                                    hideKeyboard();
                                    DBCommodity dbCommodity = new DBCommodity(CheckRatesToCustomerActivity.this);
                                    dbCommodity.deleteTableData(CheckRatesToCustomerActivity.this);
                                    startActivity(new Intent(CheckRatesToCustomerActivity.this, ShipmentDetailsCustomerActivity.class));
                                } else {
                                    JSONObject jsonObject = Json_response.getJSONObject(JSONConstant.ERROR_MESSAGES);
                                    CustomDialogForHelp customDialogForHelp = new CustomDialogForHelp(CheckRatesToCustomerActivity.this,getResources().getString(R.string.app_name),jsonObject.getString(JSONConstant.MESSAGE));
                                    customDialogForHelp.show();
